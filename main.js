...
function getTuitionFee(subjectName) {
    let Course;
    (function (Course) {
        Course[Course["IT"] = 3000] = "IT";
        Course[Course["CYBERSECURITY"] = 4000] = "CYBERSECURITY";
        Course[Course["DATASCIENCE"] = 5000] = "DATASCIENCE";
        Course[Course["AI"] = 6000] = "AI";
    })(Course || (Course = {}));
...
let answers = await inquirer.prompt([
    ...
    },
    {
        name: "subjectname",
        type: "list",
        message: "In which field You want to enroll",
        choices: ["AI", "DATASCIENCE", "CYBERSECURITY", "IT"]
    }
]);
